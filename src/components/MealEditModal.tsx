                        ...
                        <div className="space-y-4 animate-in fade-in duration-150">
                            ...
                            {imageUrl && (
                                <div className="space-y-2">
                                    <div className="relative h-40 w-full overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-900">
                                        <img
                                            src={imageUrl}
                                            alt={name || 'Receptbild'}
                            ...
                            {!imageUrl && (
                                <button
                                    type="button"
                                    onClick={() => setIsImageSearchOpen(true)}
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-dashed border-blue-300 dark:border-blue-700 bg-blue-50/60 dark:bg-blue-900/20 text-sm font-semibold text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
                                >
                                    <Search className="w-4 h-4" />
                                    {t('ai.searchImage', 'Sök bild med API')}
                                </button>
                            )}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            placeholder="https://..."
                                            className="flex-1 px-3.5 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 outline-none focus:ring-2 focus:ring-blue-500 text-xs"
                                        />
                                        <button
                                            type="button"
                                            onClick={() => setImageUrl('')}
                                            disabled={!imageUrl}
                                            className="px-3 py-2 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50 text-xs font-medium transition-colors"
                                        >
                                            <X className="w-3.5 h-3.5" />
                                        </button>
                                    </div>

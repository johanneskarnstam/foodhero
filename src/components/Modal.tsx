...
export const Modal: React.FC<ModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 sm:p-4 bg-black/50 backdrop-blur-sm">
            <div role="dialog" aria-labelledby="modal-title" aria-describedby="modal-message" className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-lg md:max-w-[calc(100vw-2rem)] 2xl:max-w-lg w-full max-h-[92vh] flex flex-col overflow-hidden transform transition-all">

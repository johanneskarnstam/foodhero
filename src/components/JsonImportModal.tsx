...
export const JsonImportModal: React.FC<JsonImportModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl md:max-w-[calc(100vw-2rem)] lg:max-w-2xl w-full p-6 border border-gray-100 dark:border-gray-700 animate-in zoom-in-95 duration-200">
